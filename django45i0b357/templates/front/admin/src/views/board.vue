<template>
	<div class="content" :style='{"alignContent":"flex-start","overflow":"hidden","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20231223/2592f2b1d33d45d299f892501055ed24.jpg) no-repeat center top / 100% 100%","display":"flex","width":"100%","position":"relative","height":"auto"}'>
		...
		<div :style='{"width":"100%","margin":"0","position":"relative","background":"url(http://codegen.caihongy.cn/20231223/3329204d7f474f8598c2b6cf87835385.gif) no-repeat center top / 100% 100%","height":"80px"}'>
			...
			<!-- 时间 -->
			<div :style='{"top":"0","color":"#fff","display":"inline-block","lineHeight":"54px","fontSize":"14px","position":"absolute","right":"60px","height":"64px"}'>{{ dates }} <span @click="backClick" style="cursor:pointer;padding: 0 0 0 8px;">管理界面</span></div>
		</div>
					...
					<div :style='{"padding":"0","margin":"0","color":"#fff","alignItems":"center","display":"flex","justifyContent":"center","alignContent":"center","flexWrap":"wrap","background":"none","width":"100%","fontSize":"14px","height":"100px","order":"1"}'>
						...
						<div :style='{"margin":"0 10px 0 0","alignItems":"center","background":"url(http://codegen.caihongy.cn/20231223/9c1f0d184ede4dee8925bb6c57ba14b7.png) no-repeat center top / 100% 100%","flexDirection":"column","display":"flex","width":"calc(20% - 10px)","justifyContent":"center","height":"100%"}'>
							...
							<div :style='{"padding":"0 0px","alignItems":"center","flexDirection":"column-reverse","display":"flex"}'>
								<div :style='{"lineHeight":"32px","fontSize":"inherit","color":"inherit","height":"32px"}'>南昌二手房总数</div>
								<div :style='{"lineHeight":"32px","fontSize":"16px","color":"#fff","fontWeight":"bold","height":"32px"}'>{{ncsecondhandhouseCount}}</div>
							</div>
						</div>
					</div>
				</div>
			...
			<div :style='{"width":"100%","padding":"0 40px","alignItems":"center","flexWrap":"wrap","display":"flex","height":"calc(100vh - 235px)"}'>
				<div class="echarts1">
					...
					<div :style='{"width":"100%","height":"calc(100% - 40px)"}'>
						<div id="ncsecondhandhouseChart1" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts2">
					<div :style='{"width":"100%","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231223/a17650c7939541fdbd37f9b82a08d2b3.png) no-repeat center bottom / 100% auto","height":"42px"}'>
					...
					<div :style='{"width":"100%","height":"calc(100% - 40px)"}'>
						<div id="ncsecondhandhouseChart2" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts3">
					<div :style='{"width":"100%","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231223/a17650c7939541fdbd37f9b82a08d2b3.png) no-repeat center bottom / 100% auto","height":"42px"}'>
					...
					<div :style='{"width":"100%","height":"calc(100% - 40px)"}'>
						<div id="ncsecondhandhouseChart3" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts4">
					<div :style='{"width":"100%","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231223/a17650c7939541fdbd37f9b82a08d2b3.png) no-repeat center bottom / 100% auto","height":"42px"}'>
					...
					<div :style='{"width":"100%","height":"calc(100% - 40px)"}'>
						<div id="ncsecondhandhouseChart4" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts5">
					<div :style='{"width":"100%","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231223/a17650c7939541fdbd37f9b82a08d2b3.png) no-repeat center bottom / 100% auto","height":"42px"}'>
					...
					<div :style='{"width":"100%","height":"calc(100% - 40px)"}'>
						<div id="ncsecondhandhouseChart5" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
		</div>
	...
	export default {
		data() {
			return {
				...
				line4: {"backgroundColor":"transparent","yAxis":{"axisLabel":{"borderType":"solid","rotate":0,"padding":0,"shadowOffsetX":0,"margin":15,"backgroundColor":"transparent","borderColor":"#000","shadowOffsetY":0,"color":"#fff","shadowBlur":0,"show":true,"inside":false,"ellipsis":"...","overflow":"none","borderRadius":0,"borderWidth":0,"width":"","fontSize":12,"lineHeight":24,"shadowColor":"transparent","fontWeight":"normal","height":""},"axisTick":{"show":true,"length":5,"lineStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"cap":"butt","color":"#fff","shadowBlur":0,"width":1,"type":"solid","opacity":1,"shadowColor":"rgba(0,0,0,.5)"},"inside":false},"splitLine":{"lineStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"cap":"butt","color":"#ccc","shadowBlur":0,"width":1,"type":"solid","opacity":1,"shadowColor":"rgba(0,0,0,.5)"},"show":true},"minInterval":1,"axisLine":{"lineStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"cap":"butt","color":"#fff","shadowBlur":0,"width":1,"type":"solid","opacity":1,"shadowColor":"rgba(0,0,0,.5)"},"show":true},"splitArea":{"show":false,"areaStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"color":"rgba(250,250,250,0.3)","opacity":1,"shadowBlur":10,"shadowColor":"rgba(0,0,0,.5)"}}},"xAxis":{"axisLabel":{"borderType":"solid","rotate":25,"padding":0,"shadowOffsetX":0,"margin":8,"backgroundColor":"transparent","borderColor":"#000","shadowOffsetY":0,"color":"#fff","shadowBlur":0,"show":true,"inside":false,"ellipsis":"...","overflow":"none","borderRadius":0,"borderWidth":0,"width":"","interval":0,"fontSize":12,"lineHeight":24,"shadowColor":"transparent","fontWeight":"normal","height":""},"axisTick":{"show":true,"length":5,"lineStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"cap":"butt","color":"#fff","shadowBlur":0,"width":1,"type":"solid","opacity":1,"shadowColor":"rgba(0,0,0,.5)"},"inside":false},"splitLine":{"lineStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"cap":"butt","color":"#fff","shadowBlur":0,"width":1,"type":"solid","opacity":1,"shadowColor":"rgba(0,0,0,.5)"},"show":false},"axisLine":{"lineStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"cap":"butt","color":"#fff","shadowBlur":0,"width":1,"type":"solid","opacity":1,"shadowColor":"rgba(0,0,0,.5)"},"show":true},"splitArea":{"show":false,"areaStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"color":"rgba(255,255,255,.3)","opacity":1,"shadowBlur":10,"shadowColor":"rgba(0,0,0,.5)"}}},"color":["#5470c6","#91cc75","#fac858","#ee6666","#73c0de","#3ba272","#fc8452","#9a60b4","#ea7ccc"],"legend":{"padding":5,"itemGap":10,"shadowOffsetX":0,"backgroundColor":"transparent","borderColor":"#ccc","shadowOffsetY":0,"orient":"horizontal","shadowBlur":0,"bottom":"auto","itemHeight":14,"show":true,"icon":"roundRect","itemStyle":{"borderType":"solid","shadowOffsetX":0,"borderColor":"inherit","shadowOffsetY":0,"color":"inherit","shadowBlur":0,"borderWidth":0,"opacity":1,"shadowColor":"transparent"},"right":"auto","top":"auto","borderRadius":0,"lineStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"color":"inherit","shadowBlur":0,"width":"auto","type":"inherit","opacity":1,"shadowColor":"transparent"},"left":"right","borderWidth":0,"width":"auto","itemWidth":25,"textStyle":{"textBorderWidth":0,"color":"#fff","textShadowColor":"transparent","ellipsis":"...","overflow":"none","fontSize":12,"lineHeight":24,"textShadowOffsetX":0,"textShadowOffsetY":0,"textBorderType":"solid","fontWeight":500,"textBorderColor":"transparent","textShadowBlur":0},"shadowColor":"rgba(0,0,0,.3)","height":"auto"},"grid":{"x":"12%","y":"15%","y2":"20%","x2":"5%"},"series":{"symbol":"emptyCircle","areaStyle":{"color":"rgba(74,199,245,.06)"},"showSymbol":true,"lineStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"color":"#4ac7f5","shadowBlur":0,"width":2,"type":"solid","opacity":1,"shadowColor":"#000"},"symbolSize":4,"emphasis":{"lineStyle":{"color":"#000"}},"itemStyle":{"borderType":"solid","shadowOffsetX":0,"borderColor":"#666","shadowOffsetY":0,"color":"inheirt","shadowBlur":0,"borderWidth":0,"opacity":1,"shadowColor":"#000"}},"tooltip":{"backgroundColor":"#fff","textStyle":{"color":"#333"}},"title":{"borderType":"solid","padding":2,"shadowOffsetX":0,"backgroundColor":"transparent","borderColor":"#ccc","shadowOffsetY":0,"shadowBlur":0,"bottom":"auto","show":false,"right":"auto","top":"auto","borderRadius":0,"left":"left","borderWidth":0,"textStyle":{"textBorderWidth":0,"color":"#fff","textShadowColor":"transparent","fontSize":14,"lineHeight":24,"textShadowOffsetX":0,"textShadowOffsetY":0,"textBorderType":"solid","fontWeight":500,"textBorderColor":"#ccc","textShadowBlur":0},"shadowColor":"transparent"}},
				...
				boardBase: {"funnelNum":8,"lineNum":8,"gaugeNum":8,"barNum":8,"pieNum":12},
